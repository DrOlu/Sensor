...
export const zhTWAiMessages: Messages = {
  ...
  'ai.chat.modelCatalogWarning': '暫時無法更新即時模型清單，目前顯示上次可用或內建的模型。',
  ...
  'ai.codebuddy.persistSession.hint': '將 CodeBuddy 自身的工作階段記錄儲存到磁碟，以便 CodeBuddy 後續恢復工作階段。關閉後將停用 CodeBuddy 的工作階段儲存；Sensor 仍可能儲存聊天記錄和外部工作階段中繼資料。檔案檢查點會略過。需要 CodeBuddy CLI 2.125.1 或更高版本。',
  ...
  'ai.grok.runtime.acp.description':
    '透過 Agent Client Protocol（grok agent stdio）接入 Grok。在 session/new 注入 Sensor MCP。關閉後使用原始 headless streaming-json CLI 路徑。',
  ...
  'ai.toolAccess.mcpPrompt.description': '把這段提示詞貼到你的 AI 用戶端（Codex、Claude Code 等），它就會幫你完成 Sensor MCP 的註冊。',
  'ai.toolAccess.mcpPrompt.enableHint': '先在下方開啟對外 MCP 開關，提示詞中才會包含 launcher 路徑。',
  'ai.toolAccess.skills.file': 'Skill 檔案',
  'ai.toolAccess.skills.description': 'Skills + CLI 模式下，Agent 會自動被指向這個本機 Skill 檔案。Sensor CLI 啟動路徑會在每個工作階段提供給 Agent。',
  'ai.toolAccess.skills.unavailable': '暫時無法取得 Skill 檔案路徑',

  'ai.externalMcp.title': '對外 MCP',
  'ai.externalMcp.description': '將 Sensor 作為 MCP 伺服器暴露給 Codex、Claude Code、Cursor、Grok 等外部用戶端。工具面與應用內 Agent 相同。用戶端連線期間請保持 Sensor 執行。',
  ...
  'ai.externalMcp.mode.description': '暫時模式會在閒置逾時後自動關閉；常開模式會在 Sensor 啟動時還原對外 MCP。',
  ...
  'ai.externalMcp.usage.keepRunning': '1. 開啟對外 MCP 開關，並保持 Sensor 執行。',
  ...
  'ai.externalMcp.permissionMode.hint': '與「設定 → AI → 安全」為同一項。自動：Sensor 寫入操作不再彈本應用核准；確認：每次詢問。外部用戶端（Codex / Claude / Grok）仍可能有自己的工具核准介面。',
  ...
  'ai.externalMcp.codexAdded': '已新增 Codex MCP 項目和 Sensor Skill。請重新啟動 Codex 或開啟新工作階段。',
  'ai.externalMcp.claudeAdded': '已新增 Claude Code MCP 項目和 Sensor Skill。請重新啟動 Claude Code 或開啟新工作階段。',
  'ai.externalMcp.grokAdded': '已新增 Grok MCP 項目和 Sensor Skill。請重新啟動 Grok 或開啟新工作階段。',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Codex 主程序處理器尚未載入。請完全重新啟動 Sensor 或重新啟動 Electron 開發程序，然後重試。',
  ...
  'ai.safety.permissionMode.description': '控制 AI 透過 Sensor 存取終端工作階段的方式。觀察者模式會阻止經由 Sensor 的寫操作；外部 Agent CLI 可能仍有自己的本機工具和核准流程。',
