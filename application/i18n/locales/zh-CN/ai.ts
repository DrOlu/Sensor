...
export const zhCNAiMessages: Messages = {
  ...
  'ai.codex.customConfigMissingEnvKey': '警告：环境变量 {envKey} 未在当前 shell 中设置。请 export 它（或从包含该变量的 shell 启动 Sensor），否则 Codex 无法鉴权。',
  ...
  'ai.chat.permConfirmDesc': 'Sensor 写操作前确认（Cursor CLI：agent + force）',
