...
export const esAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Déjalo en blanco para usar el valor de la lista de modelos cuando esté disponible; de lo contrario, Sensor usa un valor predeterminado seguro.',
  ...
  'ai.cursor.apiKeyEnvHint': 'Cursor puede usar CURSOR_API_KEY de tu shell. Guarda una clave aquí solo si quieres que Sensor la anule.',
  'ai.cursor.apiKeyOverrideHint': 'Sensor usará la clave guardada aquí antes que CURSOR_API_KEY.',
  ...
  'ai.grok.runtime.acp.description':
    'Habla con Grok mediante el Protocolo de Cliente de Agente (grok agent stdio). Inyecta el MCP de Sensor en session/new. Apágalo para usar la ruta original de CLI headless con streaming-json.',
  ...
  'ai.toolAccess.mode': 'Modo de acceso de Sensor',
  'ai.toolAccess.description': 'Elige cómo acceden los agentes externos a las sesiones de Sensor. MCP expone el servidor integrado, mientras que Habilidades + CLI apunta a los agentes hacia las habilidades locales de Sensor y los comandos de CLI.',
  ...
  'ai.toolAccess.mcpPrompt.description': 'Pega este prompt en tu cliente de IA (Codex, Claude Code, …) y registrará el MCP de Sensor por ti.',
  ...
  'ai.toolAccess.skills.description': 'En modo Habilidades + CLI, los agentes apuntan automáticamente a este archivo de skill local. La ruta del lanzador de la CLI de Sensor se entrega al agente en cada sesión.',
  ...
  'ai.externalMcp.description': 'Expón Sensor como un servidor MCP para clientes externos como Codex, Claude Code, Cursor y Grok. Usa las mismas herramientas del catálogo que los agentes de la aplicación (terminal, SFTP, Vault, reenvío de puertos). Mantén Sensor en ejecución mientras los clientes estén conectados.',
  ...
  'ai.externalMcp.mode.description': 'El modo temporal se desactiva automáticamente tras el tiempo de inactividad. El modo Siempre activo restaura el MCP externo cuando se inicia Sensor.',
  ...
  'ai.externalMcp.usage.keepRunning': '1. Activa el MCP externo y mantén Sensor en ejecución.',
  ...
  'ai.externalMcp.permissionMode.hint': 'La misma configuración que Configuración → IA → Seguridad. Automático ejecuta las herramientas de escritura de Sensor sin solicitar aprobación de Sensor; Confirmar pregunta cada vez. Los clientes externos (Codex / Claude / Grok) aún pueden mostrar su propia interfaz de aprobación de herramientas.',
  ...
  'ai.externalMcp.codexAdded': 'Entrada MCP de Codex y skill de Sensor agregados. Reinicia Codex o abre una nueva sesión de Codex.',
  'ai.externalMcp.claudeAdded': 'Entrada MCP de Claude Code y skill de Sensor agregados. Reinicia Claude Code o abre una nueva sesión de Claude Code.',
  'ai.externalMcp.grokAdded': 'Entrada MCP de Grok y skill de Sensor agregados. Reinicia Grok o abre una nueva sesión de Grok.',
  ...
  'ai.userSkills.description': 'Abre la carpeta de habilidades de Sensor para agregar tus propios directorios de habilidades. Sensor escanea estas habilidades automáticamente e inyecta solo índices ligeros, salvo que una habilidad coincida claramente con la petición actual.',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Los controladores del proceso principal de Codex aún no están cargados. Reinicia Sensor por completo o reinicia el proceso de desarrollo de Electron y vuelve a intentarlo.',
  ...
  'ai.safety.permissionMode.description': 'Controla cómo interactúa la IA con tus sesiones de terminal de Sensor. El modo Observador bloquea las operaciones de escritura que pasan por Sensor. Las CLIs de agentes externos pueden seguir teniendo sus propias herramientas locales y flujo de aprobación.',
  ...
  'ai.safety.commandTimeout.description': 'Máximo de segundos que un comando puede ejecutarse antes de ser terminado mediante la ejecución de Sensor.',
  ...
  'ai.safety.blocklist.description': 'Patrones regex para bloquear comandos peligrosos ejecutados mediante Sensor.',
  ...
  'ai.safety.note': 'Estos ajustes de seguridad se aplican a las acciones que pasan por Sensor. Las CLIs de agentes externos también pueden exponer herramientas locales regidas por el propio agente.',
