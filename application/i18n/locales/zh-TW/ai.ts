...
export const zhTWAiMessages: Messages = {
  ...
  'ai.externalMcp.permissionMode.hint': '與「設定 → AI → 安全」為同一項。自動：Sensor 寫入操作不再彈本應用審批；確認：每次詢問。外部用戶端（Codex / Claude / Grok）仍可能有自己的工具審批介面。',
  ...
  'ai.chat.permConfirmDesc': 'Sensor 寫入前確認（Cursor CLI：agent + force）',
