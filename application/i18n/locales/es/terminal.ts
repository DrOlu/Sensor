...
export const esTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'Sensor agregará hooks de prompt OSC 7 para el usuario remoto actual. Esto ayuda a que SFTP siga el directorio de la terminal después de sudo o su.',
  ...
  'terminal.et.proxyUnsupported': 'EternalTerminal no admite actualmente la configuración de proxy de Sensor. Usa SSH o quita el proxy de este host.',
  'terminal.et.multiJumpUnsupported': 'EternalTerminal admite actualmente como máximo un host de salto en Sensor.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'Combina los cambios de ambos lados cuando sea posible; si Sensor no puede decidir con seguridad, te pedirá que elijas.',
  ...
  'cloudSync.localBackups.desc': 'Sensor conserva puntos de restauración locales antes de los cambios de versión de la app y antes de las restauraciones de la bóveda.',
  'cloudSync.localBackups.retentionTitle': 'Retención de copias de seguridad',
  'cloudSync.localBackups.retentionDesc': 'Elige cuántas copias de seguridad locales debe conservar Sensor.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'Esta plataforma no expone un keychain seguro a Sensor, por lo que las copias de seguridad locales no se pueden escribir de forma segura. Instala Sensor en un sistema con un keychain compatible para habilitar el historial de copias de seguridad locales.',
  ...
  'cloudSync.githubFlow.desc': 'Copia el código de abajo e ingrésalo en GitHub para autorizar a Sensor.',
  ...
  'snippets.import.toast.invalidDesc': 'Este no es un archivo de snippets válido de Sensor.',
  ...
  'snippets.import.modal.desc': 'Elige uno o más archivos JSON de snippets de Sensor. Sensor los mostrará en vista previa antes de importar cualquier cosa.',
