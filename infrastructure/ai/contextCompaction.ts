...
export const CONTEXT_COMPACTION_SYSTEM_PROMPT = `You are summarizing a long Sensor agent conversation so it can continue without exceeding the model context window.
