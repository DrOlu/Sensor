...
export const ruTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'Sensor добавит хуки OSC 7 для текущего удалённого пользователя. Это помогает SFTP следовать за каталогом терминала после sudo или su.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'По возможности объединять изменения с обеих сторон; если Sensor не сможет безопасно выбрать, он попросит вас решить вручную.',
  ...
  'cloudSync.localBackups.desc': 'Sensor сохраняет локальные точки восстановления перед сменой версии приложения и перед восстановлением хранилища.',
  'cloudSync.localBackups.retentionTitle': 'Хранение резервных копий',
  'cloudSync.localBackups.retentionDesc': 'Выберите, сколько локальных резервных копий должен хранить Sensor.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'Эта платформа не предоставляет Sensor безопасное хранилище ключей, поэтому локальные резервные копии нельзя записывать безопасно. Установите Sensor в систему с поддерживаемым keychain, чтобы включить историю локальных резервных копий.',
  ...
  'cloudSync.githubFlow.desc': 'Скопируйте код ниже и введите его на GitHub, чтобы авторизовать Sensor.',
  ...
  'snippets.import.toast.invalidDesc': 'Это невалидный файл сниппетов Sensor.',
  ...
  'snippets.import.modal.desc': 'Выберите один или несколько JSON-файлов сниппетов Sensor. Sensor сначала покажет результат разбора и ничего не импортирует без подтверждения.',
