...
module.exports = {
    ...
    win: {
        ...
        // Windows, install to Program Files (x86), and leave Sensor.exe
        ...
        extraResources: [
            ...
            {
                from: 'electron/bridges/windowsHelloHelper/build/${arch}/SensorWindowsHello.exe',
                to: 'windowsHello/SensorWindowsHello.exe',
                filter: ['**/*']
            }
        ]
    },
