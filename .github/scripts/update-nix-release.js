...
const x64AppImage = findArtifact(args.artifacts, `Sensor-${version}-linux-x86_64.AppImage`);
const arm64AppImage = findArtifact(args.artifacts, `Sensor-${version}-linux-arm64.AppImage`);
...
console.log(`Updated nix/release.nix for Sensor ${version}`);
