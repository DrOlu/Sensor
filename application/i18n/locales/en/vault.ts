...
export const enVaultMessages: Messages = {
  ...
  'vault.import.progress.summary':
    'Imported {count} hosts; skipped {skipped}; duplicates {duplicates}.',
  'vault.import.progress.keepOpen': 'Keep Sensor open while the import runs in the background.',
  ...
  'settings.sshDeepLink.enable': 'Open ssh:// and telnet:// links with Sensor',
  'settings.sshDeepLink.enableDesc': 'Allow Sensor to handle ssh:// and telnet:// links from browsers and other apps, plus PuTTY-style launches such as -ssh user@host -P 22 -pw password.',
  'settings.explorerContextMenu.title': 'Windows Explorer',
  'settings.explorerContextMenu.enable': 'Show “Open in Sensor” in folder context menus',
  ...
  'settings.jmsDeepLink.enableDesc': 'Register Sensor as the handler for JumpServer jms:// client links. May conflict with the official JumpServer client.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'The current group has algorithm overrides set for: {categories}. The "Reset" button here falls back to the group\'s lists, not Sensor\'s defaults. To ignore the group restriction, clear the override in the group\'s algorithm settings.',
