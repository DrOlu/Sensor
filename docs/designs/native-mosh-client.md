...
Sensor requires `moshcatty-0.1.6+`. That release includes stock-aligned speculative local echo hardening
...
- **2026-07-11:** Speculative local echo (prediction underlines) lives in
  ...
  (Sensor #2121). Sensor does not implement prediction in the renderer.
