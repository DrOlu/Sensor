...
export const enAiMessages: Messages = {
  ...
  'ai.codex.customConfigMissingEnvKey': 'Warning: {envKey} is not set in your shell environment. Export it (or launch Sensor from a shell that has it) so Codex can authenticate.',
  ...
  'ai.chat.permConfirmDesc': 'Ask before Sensor writes (Cursor CLI: agent + force)',
