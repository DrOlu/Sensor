...
main() {
  ...
  electron_bin="${TEMP_DIR}/opt/Sensor/sensor"
  main_binary="${TEMP_DIR}/opt/Sensor/sensor"
  build_release_pty="${TEMP_DIR}/opt/Sensor/resources/app.asar.unpacked/node_modules/node-pty/build/Release/pty.node"
  prebuild_pty="${TEMP_DIR}/opt/Sensor/resources/app.asar.unpacked/node_modules/node-pty/prebuilds/linux-${prebuild_arch}/pty.node"
  serialport_root="${TEMP_DIR}/opt/Sensor/resources/app.asar.unpacked/node_modules/@serialport/bindings-cpp"
