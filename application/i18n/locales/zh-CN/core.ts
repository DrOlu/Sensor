...
export const zhCNCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'Sensor 已锁定',
  'appLock.reason.default': '输入锁定密码以继续。',
  'appLock.reason.startup': '每次打开此窗口时，Sensor 都会锁定。',
  'appLock.reason.idle': 'Sensor 已因长时间无操作而锁定。',
  'appLock.reason.manual': 'Sensor 已被手动锁定。',
  ...
  'settings.appLock.enabledStatus': '已启用。Sensor 会在启动、长时间无操作或手动锁定时要求输入密码。',
  'settings.appLock.disabledStatus': '密码已保存，但应用锁定当前关闭。',
  'settings.appLock.disableTitle': '关闭应用锁定',
  'settings.appLock.disableDescription': '输入当前锁定密码后停止锁定 Sensor。已保存的密码会被删除；以后重新启用时需要创建新密码。',
  'settings.appLock.disable': '关闭应用锁定',
  'settings.appLock.disabling': '正在关闭...',
  'settings.appLock.setupPasswordTitle': '创建锁定密码',
  'settings.appLock.setupPasswordDescription': '此密码用于解锁 Sensor，也用于以后修改或关闭应用锁定。',
  ...
  'settings.appLock.systemUnlock.desc': '在此设备上使用 {label} 作为解锁 Sensor 的另一种方式。',
  'settings.appLock.systemUnlock.unavailableDesc': '此设备当前无法使用 {label}。',
  'settings.appLock.systemUnlock.unavailable': '此设备当前无法使用系统解锁。',
  'settings.appLock.systemUnlock.locked': '请先解锁 Sensor，再更改系统解锁。',
  'settings.appLock.systemUnlock.autoPrompt.label': '自动弹出 {label}',
  'settings.appLock.systemUnlock.autoPrompt.desc': '当 Sensor 等待解锁时，自动显示 {label} 验证提示。',
  ...
  'settings.autoLaunch.enabledDesc': '系统启动时自动运行 Sensor，并隐藏到系统托盘。',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': '打开主机库时静默导入 OpenSSH known_hosts 中的记录。关闭后，Sensor 已知主机与系统信任库保持独立；仍可通过「扫描系统」手动导入。',
...
`,
  ...
  'settings.appearance.appIcon.desc': '选择 Dock/任务栏图标风格，切换应用时更容易找到 Sensor。运行时生效，安装包内的图标不会改变。',
  ...
  'vault.import.progress.keepOpen': '导入正在后台进行，请保持 Sensor 开启。',
  ...
  'settings.plugins.description': '由开发插件提供、经 Sensor 原生组件验证的设置。',
  ...
  'plugins.authentication.description': '请在此 Sensor 对话框中完成认证请求。',
