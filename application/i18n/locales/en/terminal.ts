...
export const enTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'Sensor will add OSC 7 prompt hooks for the current remote user. This helps SFTP follow the terminal directory after sudo or su.',
  ...
  'terminal.et.proxyUnsupported': 'EternalTerminal does not currently support Sensor proxy settings. Use SSH or remove the proxy for this host.',
  'terminal.et.multiJumpUnsupported': 'EternalTerminal currently supports at most one jump host in Sensor.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'Combine changes from both sides when possible; if Sensor cannot decide safely, ask you to choose.',
  ...
  'cloudSync.localBackups.desc': 'Sensor keeps local restore points before app version changes and before vault restores.',
  'cloudSync.localBackups.retentionTitle': 'Backup Retention',
  'cloudSync.localBackups.retentionDesc': 'Choose how many local backups Sensor should keep.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'This platform does not expose a secure keychain to Sensor, so local backups cannot be written safely. Install Sensor on a system with a supported keychain to enable the local backup history.',
  ...
  'cloudSync.githubFlow.desc': 'Copy the code below and enter it on GitHub to authorize Sensor.',
  ...
  'snippets.import.toast.invalidDesc': 'This is not a valid Sensor snippets file.',
  ...
  'snippets.import.modal.desc': 'Choose one or more Sensor snippets JSON files. Sensor will preview them before anything is imported.',
  ...
  'serial.encoding.pendingInput': 'Submit or clear the current input before changing the encoding.',
