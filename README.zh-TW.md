...
安裝 [Scoop](https://scoop.sh/) 後，可以透過社群維護的 [lemon 軟體來源](https://github.com/hoilc/scoop-lemon/blob/master/bucket/netcatty.json) 安裝 Sensor。此軟體來源從 Sensor 官方 GitHub Releases 下載安裝檔：
