...
export const ruCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'Sensor заблокирован',
  'appLock.reason.default': 'Введите пароль блокировки, чтобы продолжить.',
  'appLock.reason.startup': 'Sensor блокируется при каждом открытии этого окна.',
  'appLock.reason.idle': 'Sensor заблокирован после периода бездействия.',
  'appLock.reason.manual': 'Sensor был заблокирован вручную.',
  ...
  'topTabs.lockApp': 'Заблокировать Sensor',
  ...
  'settings.appLock.description': 'Требовать локальный пароль блокировки при открытии Sensor, после бездействия или при ручной блокировке.',
  ...
  'settings.appLock.enabledStatus': 'Включена. Sensor блокируется при запуске, после бездействия и при ручной блокировке.',
  ...
  'settings.appLock.disableDescription': 'Введите текущий пароль блокировки, чтобы Sensor перестал блокироваться. Сохранённый пароль будет удалён; для повторного включения нужно создать новый.',
  ...
  'settings.appLock.setupPasswordDescription': 'Этот пароль нужен для разблокировки Sensor, а также для изменения или отключения блокировки позже.',
  ...
  'settings.appLock.systemUnlock.desc': 'Используйте {label} как альтернативный способ разблокировать Sensor на этом устройстве.',
  ...
  'settings.appLock.systemUnlock.locked': 'Разблокируйте Sensor перед изменением системной разблокировки.',
  'settings.appLock.systemUnlock.autoPrompt.label': 'Открывать {label} автоматически',
  'settings.appLock.systemUnlock.autoPrompt.desc': 'Автоматически показывать запрос {label}, когда Sensor ожидает разблокировки.',
  ...
  'settings.autoLaunch.enabledDesc': 'Автоматически запускать Sensor при входе в систему, свернутым в системный трей.',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': 'При открытии хранилища тихо импортировать записи из OpenSSH known_hosts. Отключите, чтобы держать известные хосты Sensor отдельно; кнопка «Сканировать систему» по-прежнему импортирует вручную.',
...
`,
  ...
  'plugins.authentication.description': 'Завершите запрос аутентификации в этом диалоге Sensor.',
