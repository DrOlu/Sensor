...
module.exports = {
    ...
    mac: {
        ...
        // signing in the afterPack hook — this prevents macOS Code Signing
        // Monitor from killing the app on launch (SIGKILL / Code Signature
        // Invalid). See scripts/afterPackMacUuid.cjs for details.
