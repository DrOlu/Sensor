...
const messages: Record<string, string> = {
  ...
  "vault.import.progress.keepOpen": "You can keep using Sensor while this runs.",
...
test("import format step keeps destination settings off the main card grid", async () => {
  ...
  assert.match(source, /data-import-source-prompt=\{step === "securecrt-source" \? "securecrt" : "finalshell"\}/);
