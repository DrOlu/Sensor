...
export const zhTWCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'Sensor 已鎖定',
  'appLock.reason.default': '請輸入鎖定密碼以繼續。',
  'appLock.reason.startup': 'Sensor 會在每次開啟這個視窗時鎖定。',
  'appLock.reason.idle': 'Sensor 已因閒置逾時而鎖定。',
  'appLock.reason.manual': 'Sensor 已被手動鎖定。',
  ...
  'settings.appLock.description': '在 Sensor 開啟、閒置一段時間或手動鎖定後，要求輸入本機的鎖定密碼。',
  ...
  'settings.appLock.enabledStatus': '已啟用。Sensor 會在啟動、閒置逾時以及手動鎖定時要求輸入密碼。',
  'settings.appLock.disabledStatus': '密碼已儲存，但應用程式鎖定目前為關閉。',
  'settings.appLock.disableTitle': '關閉應用程式鎖定',
  'settings.appLock.disableDescription': '輸入目前的鎖定密碼即可停止鎖定 Sensor。已儲存的密碼會一併移除；日後要再啟用必須重新建立新密碼。',
  'settings.appLock.disable': '關閉應用程式鎖定',
  'settings.appLock.disabling': '正在關閉...',
  'settings.appLock.setupPasswordTitle': '建立鎖定密碼',
  'settings.appLock.setupPasswordDescription': '這組密碼用來解鎖 Sensor，日後修改或關閉應用程式鎖定時也會用到。',
  ...
  'settings.appLock.systemUnlock.desc': '在這台裝置上，使用 {label} 作為解鎖 Sensor 的另一種方式。',
  'settings.appLock.systemUnlock.unavailableDesc': '這台裝置目前無法使用 {label}。',
  'settings.appLock.systemUnlock.unavailable': '這台裝置目前無法使用系統解鎖。',
  'settings.appLock.systemUnlock.locked': '請先解鎖 Sensor，再變更系統解鎖設定。',
  'settings.appLock.systemUnlock.autoPrompt.label': '自動開啟 {label}',
  'settings.appLock.systemUnlock.autoPrompt.desc': '當 Sensor 等待解鎖時，自動顯示 {label} 驗證提示。',
  ...
  'settings.autoLaunch.enabledDesc': '系統啟動時自動執行 Sensor，並隱藏到系統匣。',
  ...
  'settings.update.hint': 'Sensor 從 GitHub Releases 檢查更新。',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': '開啟主機庫時靜默匯入 OpenSSH known_hosts 中的記錄。關閉後，Sensor 已知主機與系統信任庫保持獨立；仍可透過「掃描系統」手動匯入。',
...
`,
  ...
  'settings.appearance.appIcon.desc': '選擇 Dock/工作列圖示風格，切換應用程式時更容易找到 Sensor。執行時生效，安裝檔內的圖示不會改變。',
  ...
  'vault.import.progress.keepOpen': '匯入正在背景執行，請保持 Sensor 開啟。',
  ...
  'pf.type.dynamic.desc': '動態轉發將 Sensor 作為 SOCKS 代理使用。',
  ...
  'settings.plugins.description': '由開發外掛程式提供、經 Sensor 原生元件驗證的設定。',
  ...
  'plugins.authentication.description': '請在此 Sensor 對話框中完成驗證要求。',
