...
const zhCN: Messages = {
  ...
  'cloudSync.localBackups.desc': 'Sensor 会在版本变化前，以及恢复主机库前，自动留下一份本地恢复点。',
  'cloudSync.localBackups.retentionTitle': '备份保留数量',
  'cloudSync.localBackups.retentionDesc': '设置 Sensor 最多保留多少份本地备份。',
  ...
  'cloudSync.localBackups.unavailableDesc': '当前平台未提供受支持的安全密钥库，Sensor 无法安全地写入本地备份。请在支持系统钥匙串的环境中运行，或改用云同步保留恢复点。',
  ...
  'cloudSync.githubFlow.desc': '复制下面的 code，并在 GitHub 页面输入以授权 Sensor。',
  ...
  'ai.defaultAgent.catty': 'Sensor（内置）',
  'ai.toolAccess.title': '工具接入',
  'ai.toolAccess.mode': 'Sensor 接入模式',
  'ai.toolAccess.description': '选择外部 ACP Agent 访问 Sensor 会话的方式。MCP 会暴露内置服务器，Skills + CLI 会引导 Agent 读取本地 Skill 并调用 Sensor CLI。',
  ...
  'ai.chat.placeholderDefault': '向 Sensor Agent 发送消息...',
  ...
  'ai.safety.permissionMode.description': '控制 AI 与终端的交互方式。观察者模式会通过 Sensor 阻止所有写操作，对内置和 ACP Agent 均生效。确认模式对 ACP Agent 仅为建议性（ACP Agent 有自己的工具审批流程）。',
  ...
  'ai.safety.blocklist.description': '用于拦截危险命令的正则表达式。通过 Sensor 执行层对内置和 ACP Agent 均生效。',
