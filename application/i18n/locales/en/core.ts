...
export const enCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'Sensor is locked',
  'appLock.reason.default': 'Enter your lock password to continue.',
  'appLock.reason.startup': 'Sensor locks each time this window opens.',
  'appLock.reason.idle': 'Sensor locked after the inactivity timeout.',
  'appLock.reason.manual': 'Sensor was locked manually.',
  ...
  'settings.appLock.description': 'Require a local lock password when Sensor opens, after inactivity, or when you lock it manually.',
  ...
  'settings.appLock.enabledStatus': 'Enabled. Sensor locks on startup, after inactivity, and when you lock it manually.',
  ...
  'settings.appLock.disableDescription': 'Enter the current lock password to stop locking Sensor. The saved password will be removed; turning App Lock on again requires creating a new one.',
  ...
  'settings.appLock.setupPasswordDescription': 'This password is required to unlock Sensor and to change or turn off App Lock later.',
  ...
  'settings.appLock.systemUnlock.desc': 'Use {label} as an alternate way to unlock Sensor on this device.',
  ...
  'settings.appLock.systemUnlock.locked': 'Unlock Sensor before changing system unlock.',
  'settings.appLock.systemUnlock.autoPrompt.label': 'Open {label} automatically',
  'settings.appLock.systemUnlock.autoPrompt.desc': 'Show the {label} prompt automatically when Sensor is waiting to unlock.',
  ...
  'settings.autoLaunch.enabledDesc': 'Automatically start Sensor when you log in, hidden in the system tray.',
  ...
  'settings.sessionRestore.startupLandingDesc': 'Choose whether to open the host home page or a local terminal when Sensor starts with no restored sessions.',
